...
# _sf, _si y _parse_fecha viven en utils.py. Se importan acá —y no se usan
# solo internamente— porque data_helper, modulo_inicio, modulo_productos y
# order_helper hacen `from excel_helper import _sf`; el import los re-exporta.
